---
tags: [química, N2, propiedades-periódicas, tendencias]
nivel: N2
fecha: 2026-04-23
---
...
- H: 53 pm, Cs: 265 pm.
- Átomo más grande: Cesio. Más pequeño: Helio.
...
### Primera, segunda, tercera EI
- Quitar un segundo electrón siempre requiere más energía que el primero.
- Saltos enormes al romper el "caparazón" del gas noble.
...
### Tendencias
- Período → **aumenta** hacia la derecha.
- Grupo → **disminuye** hacia abajo.

### Valores de referencia
- **Flúor**: 3,98 (el más electronegativo).
- **Cesio, francio**: ~0,7 (los menos).
- Oxígeno: 3,44. Nitrógeno: 3,04. Carbono: 2,55. Hidrógeno: 2,20.
...
- Metales: tienden a perder electrones (baja EI, baja χ).
- No metales: tienden a ganar electrones (alta EI, alta χ).

### Tendencias
- Período → **disminuye** hacia la derecha (más no metálico).
- Grupo → **aumenta** hacia abajo (más metálico).

## Resumen de tendencias

| Propiedad | Izquierda → derecha (período) | Arriba → abajo (grupo) |
|---|---|---|
...
- Metales de transición: puntos de fusión altos.
- Gases nobles: puntos de fusión muy bajos.
- Densidad: máxima en Os (osmio) e Ir (iridio).
...
- Predice cómo reaccionarán los elementos.
- Explica familias de elementos con comportamiento similar.
- Útil para diseñar compuestos con propiedades deseadas.
