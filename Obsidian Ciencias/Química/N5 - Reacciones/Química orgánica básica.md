---
tags: [química, N5, orgánica, grupos-funcionales, hidrocarburos]
nivel: N5
fecha: 2026-04-24
---
...
|---|---|---|---|
| **Alcanos** | *sp³* | C<sub>n</sub>H<sub>2n+2</sub> | Metano CH₄, etano C₂H₆, butano C₄H₁₀ |
| **Alquenos** | *sp²* | C<sub>n</sub>H<sub>2n</sub> | Etileno C₂H₄ |
| **Alquinos** | *sp* | C<sub>n</sub>H<sub>2n−2</sub> | Acetileno C₂H₂ |
...
|---|---|---|
| **Sustitución** (S<sub>N</sub>1, S<sub>N</sub>2) | Un grupo reemplaza a otro | Saponificación de ésteres |
