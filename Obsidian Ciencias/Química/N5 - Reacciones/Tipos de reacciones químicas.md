---
tags: [química, N5, reacciones, estequiometría]
nivel: N5
fecha: 2026-04-23
---
...
Ejemplos:
- `2 H₂ + O₂ → 2 H₂O`
- `N₂ + 3 H₂ → 2 NH₃` (síntesis del amoníaco, Haber-Bosch)
- `Fe + S → FeS`
...
Ejemplos:
- `2 H₂O → 2 H₂ + O₂` (electrólisis)
- `CaCO₃ → CaO + CO₂` (calentamiento de caliza → cal viva)
- `2 KClO₃ → 2 KCl + 3 O₂`
...
Ejemplos:
- `AgNO₃ + NaCl → AgCl↓ + NaNO₃` (precipitación)
- `HCl + NaOH → NaCl + H₂O` (neutralización)
...
Todas las combustiones y corrosión son redox.
Ver [[Celda de combustible de tierra]].
...
**Ácidos**: donan H⁺ (Brønsted-Lowry) o aceptan e⁻ (Lewis).
**Bases**: aceptan H⁺ o donan e⁻.
...
2. Usar las proporciones molares de la ecuación.
3. Convertir moles resultantes a gramos si se necesita.
