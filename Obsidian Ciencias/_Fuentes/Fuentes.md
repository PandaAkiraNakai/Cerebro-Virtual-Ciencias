...
## 🔎 Portales y agregadores generales

Buscan en múltiples bases de datos al mismo tiempo.

| Fuente | URL | Nota |
|---|---|---|
| BASE (Bielefeld Academic Search Engine) | https://www.base-search.net/ | Uno de los mayores buscadores open access |
| CORE | https://core.ac.uk/ | 250 M+ artículos de repositorios |
| Google Scholar | https://scholar.google.com/ | Literatura científica general |
| OpenAlex | https://openalex.org/ | Competidor moderno de Google Scholar (2025) |
| Semantic Scholar | https://www.semanticscholar.org/ | Usa IA para recomendar papers |
| ScienceDaily | https://www.sciencedaily.com/ | ✅ Primera recolección, divulgación |

## 🟢 Repositorios abiertos multidisciplinarios

| Fuente | URL | Nota |
|---|---|---|
| Zenodo (CERN) ⭐ | https://zenodo.org/ | Respaldo CERN, admite cualquier tipo de dato |
| arXiv | https://arxiv.org/ | Preprints (física, mat., CS) desde 1991 |
| Open Science Framework (OSF) | https://osf.io/ | Preprints y datos |
| ScienceOpen | https://www.scienceopen.com/ | Open access + comentarios peer-reviewed |
| Figshare | https://figshare.com/ | Datasets, presentaciones, posters con DOI |
| OpenGrey | https://www.opengrey.eu/ | Literatura gris, tesis no publicadas |
| ResearchGate | https://www.researchgate.net/ | Red de investigadores |

## 🏛️ Repositorios institucionales (top universidades)

| Institución | Repositorio | URL |
|---|---|---|
| Harvard | DASH | https://dash.harvard.edu/ |
| MIT | DSpace@MIT | https://dspace.mit.edu/ |
| Stanford | Stanford Digital Repository | https://purl.stanford.edu/ |
| Cambridge | Apollo | https://www.repository.cam.ac.uk/ |
| Oxford | Oxford Research Archive | https://ora.ox.ac.uk/ |
| UC System | eScholarship | https://escholarship.org/ |
...
| Fuente | URL | Nota |
|---|---|---|
| Paleobiology Database ⭐ | https://paleobiodb.org/ | Base taxonómica global de fósiles |
| Macrostrat | https://macrostrat.org/ | Geología + paleontología |
| Geological Timescale | http://www.geotimescale.org/ | Escala de tiempo geológica |
| Fossil Directory / Museum | https://fossilmuseum.org/ | Directorio fósil |
| Paleontology Online | https://www.palaeontologyonline.com/ | Divulgación académica |
| The Paleontological Society | https://www.paleosoc.org/ | Sociedad científica |
...
| Science Magazine | https://www.science.org/ | Revista |
| Scientific American | https://www.scientificamerican.com/ | Divulgación |
| PLoS | https://plos.org/ | Open access |

## 🧍 Antropología

| Fuente | URL | Nota |
|---|---|---|
| AnthroSource (AAA) ⭐ | https://anthrosource.onlinelibrary.wiley.com/ | Revistas AAA |
| American Anthropological Association | https://americananthro.org/ | Sociedad |
| eHRAF World Cultures | https://ehrafworldcultures.yale.edu/ | Culturas del mundo |
| Institute of Human Origins (ASU) | https://iho.asu.edu/ | Orígenes humanos |
| JSTOR | https://www.jstor.org/ | Humanidades; artículos parcialmente gratis |
| Smithsonian — Anthropology Research Guide | https://library.si.edu/research/anthropology | |
| Anthropological Literature (Harvard) | https://library.harvard.edu/ | |
| Society for Applied Anthropology | https://www.sfaa.org/ | |
| AnthroBase | https://www.anthropobase.com/ | |
| Chaco Research Archive | https://www.chacoarchive.org/ | Arqueología Chaco |
| TDAR — Digital Archaeological Record | https://www.tdar.org/ | Arqueología digital |
| National Archaeological Database | https://www.nadb.org/ | |

## ⚗️ Química

| Fuente | URL | Nota |
|---|---|---|
| PubChem (NIH) ⭐ | https://pubchem.ncbi.nlm.nih.gov/ | Moléculas y propiedades |
| ChemSpider (RSC) | https://www.chemspider.com/ | |
| NIST Chemistry WebBook | https://webbook.nist.gov/chemistry/ | Datos físico-químicos |
| DrugBank | https://go.drugbank.com/ | Fármacos |
| Reaxys | (institucional) | Reacciones |
| SciFinder | (institucional) | Literatura química CAS |
| ACS Publications | https://pubs.acs.org/ | Revistas ACS |
| Royal Society of Chemistry | https://www.rsc.org/ | |
| ScienceDirect | https://www.sciencedirect.com/ | Revistas Elsevier |
| Organic Chemistry Portal | https://www.organic-chemistry.org/ | |
| Eric Weisstein's World of Chemistry | https://scienceworld.wolfram.com/chemistry/ | |
| The Periodic Table of Videos | https://www.periodicvideos.com/ | Divulgación |
| Chemistry Open | https://onlinelibrary.wiley.com/journal/27914254 | Open access |
| Molecules (MDPI) | https://www.mdpi.com/journal/molecules | Open access |
...
| OneGeology | https://www.onegeology.org/ | Mapas globales |
...
## 📰 Revistas científicas Open Access

### Generales
- PLOS ⭐ — https://plos.org/
- Frontiers ⭐ — https://www.frontiersin.org/
- Nature Open Access — https://www.nature.com/nature/
...
- ZooKeys — https://zookeys.pensoft.net/
- PhytoKeys — https://phytokeys.pensoft.net/

### Química
- Chemistry Open — https://onlinelibrary.wiley.com/journal/27914254
...
| Fuente | URL | Nota |
|---|---|---|
| ProQuest Theses & Dissertations Global | (institucional) | Muchas accesibles desde universidades |
| EThOS (British Library) | https://ethos.bl.uk/ | Tesis británicas |
| OpenThesis | https://www.openthesis.org/ | |
| DART (tesis canadienses) | https://www.theses.ca/ | |

## 📚 Directorios de revistas

| Fuente | URL | Nota |
|---|---|---|
| DOAJ ⭐ | https://doaj.org/ | 9000+ revistas open access peer-reviewed |
| SHERPA/RoMEO | https://v2.sherpa.ac.uk/romeo/ | Políticas de copyright |
| OpenDOAR | https://v2.sherpa.ac.uk/opendoar/ | Directorio de repositorios OA globales (5983+ en 2025) |
| Scimago Journal Ranking | https://www.scimagojr.com/ | Métricas de revistas |

## 🔬 Datos y datasets

| Fuente | URL | Nota |
|---|---|---|
| Zenodo Datasets | https://zenodo.org/search?q=type:dataset | |
| Figshare | https://figshare.com/ | |
| Harvard Dataverse | https://dataverse.harvard.edu/ | |
| Dryad ⭐ | https://datadryad.org/ | Datos científicos curados |
| Open ICPSR | https://www.openicpsr.org/ | Ciencias sociales |
| re3data | https://www.re3data.org/ | Directorio de repositorios de datos |

## 🔍 Metabuscadores y herramientas

| Herramienta | URL | Nota |
|---|---|---|
| CrossRef | https://www.crossref.org/ | DOI, citas |
| ORCID | https://orcid.org/ | Identificador de investigadores |
| OpenAIRE | https://www.openaire.eu/ | Portal europeo open access |
| Unpaywall | https://unpaywall.org/ | Versión legal gratis de papers de pago |
| Kopernio (Clarivate) | (extensión de navegador) | |

## 🌐 Portales gubernamentales / institucionales extra

| Fuente | URL | Nota |
|---|---|---|
| Science.gov | https://www.science.gov/ | Portal científico del gobierno EE. UU. |
| National Geographic — Science | https://www.nationalgeographic.com/science | Divulgación |
| Smithsonian Magazine | https://www.smithsonianmag.com/ | Divulgación |
| JSTOR Daily | https://daily.jstor.org/ | Divulgación |

## 🗄️ Bases con paywall / acceso institucional

| Fuente | Acceso |
|---|---|
| Web of Science | Institucional |
| Scopus | Institucional |
| ProQuest | Parcial gratuito |
| Reaxys / SciFinder | Institucional (química) |

---

## ⚡ Tips rápidos por caso de uso
...
## 📝 Cómo citar una fuente en una nota del vault

En el frontmatter:

```yaml
fuente: <Nombre tal como aparece en este catálogo>
url: <URL específica del artículo o dataset>
doi: <si aplica>
```

Al final de la nota, un bloque `## Enlaces` con `[[Índice]]` y las notas relacionadas.
